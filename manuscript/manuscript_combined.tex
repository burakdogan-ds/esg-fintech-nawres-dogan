...
%  Sedghiani & Doğan
%
%  Prepared for submission to: FinTech (MDPI), ISSN 2674-1032
%  https://www.mdpi.com/journal/fintech
%
%  NOTE FOR AUTHORS:
%  This file is a standalone, compilable LaTeX source written in
%  MDPI house style (numbered references in square brackets, CRediT
%  author contributions, standard MDPI back-matter sections).
%  For the final upload, paste the body into the official MDPI LaTeX
%  template (Definitive_Article on Overleaf or MDPI's LaTeX gallery)
%  so that the publisher-side class file (mdpi.cls) is applied.
% =====================================================================
...
% =====================================================================
%  Title and authors  (MDPI house style: numbered author affiliations,
%  corresponding author marked, ORCIDs visible)
% =====================================================================
\title{\textbf{ESG Performance and Financial Outcomes:\\
A Comparative Analysis of U.S. FinTech and Traditional Financial Institutions}}

\author[1,*]{Nawres Sedghiani\,\orcidlink{0009-0000-4652-4756}}
\author[2]{Burak Doğan\,\orcidlink{0000-0002-9585-3318}}

\affil[1]{\small Graduate School, Bahçeşehir University, Çırağan Cad., Beşiktaş 34349, Istanbul, Türkiye; nawres.sedghiani@bahcesehir.edu.tr}
\affil[2]{\small Department of Economics, Faculty of Economics, Administrative and Social Sciences (FEASS), Bahçeşehir University, Çırağan Cad., Beşiktaş 34349, Istanbul, Türkiye; burak.dogan@bau.edu.tr}
\affil[*]{\small \textbf{Correspondence:} nawres.sedghiani@bahcesehir.edu.tr}
...
Simultaneously, the financial sector itself is experiencing significant technological disruption. The emergence of financial technology (FinTech) has reshaped how financial services are delivered, monitored, and regulated~[11]. Digital platforms, blockchain systems, artificial intelligence, and data-driven risk assessment tools have not only enhanced operational efficiency but also created new opportunities for embedding sustainability principles into financial activities~[17]. As a result, sustainability is no longer viewed solely as a regulatory obligation but increasingly as a strategic component of competitive advantage.
...
From a traditional shareholder value perspective, ESG initiatives may impose additional operational and compliance costs that potentially reduce short-term profitability. According to shareholder theory~[14], the maximization of shareholders' interest is the greatest objective of a company, and investments in environmental protection programs, social responsibility initiatives, governance restructuring and regulatory compliance often require substantial financial resources. Garcia-Castro et al.~[16], for instance, discuss how corporate spending on environmental and social activities can negatively affect short-term financial performance, supporting the argument that ESG engagement may initially act as a financial burden. This view suggests that ESG represents a trade-off between social responsibility and shareholder returns.

In contrast, stakeholder theory~[12] proposes that ESG engagement should not be merely viewed as a cost, but rather as a strategic investment. By addressing the concerns of customers, employees, regulators and investors, firms can enhance their reputation, strengthen stakeholder relationships, and improve long-term value creation. Improved labor practices may increase employee productivity, while stronger governance mechanisms can enhance managerial efficiency and transparency. Under this perspective, ESG contributes positively to firm performance through both reputational and operational improvements~[20].

Empirical evidence increasingly supports this strategic theory. Several studies document a positive association between ESG performance and accounting-based as well as market-based financial indicators. Bahadori et al.~[5] show that firms with higher ESG scores demonstrate greater profitability after controlling for firm characteristics. Xie et al.~[29], Masila et al.~[21] and Nzekwe et al.~[23] further report improvements in corporate value and financial performance associated with stronger ESG ratings. Similarly, Friede et al.~[13] and Alshehhi et al.~[4] found that about 90\% and 78\% of studies respectively share a positive relationship between ESG and firms' financial performance.

Beyond the stakeholder perspective, signaling theory~[26] provides an additional explanation for the relationship between ESG engagement and a firm's financial performance. In capital markets characterized by information asymmetry between managers and investors, ESG disclosures serve as credible signals of firm quality. Strong ESG performance signals transparency, ethical management, and long-term strategic orientation to investors and other stakeholders. Ahmad et al.~[2] argue that ESG disclosures enhance stakeholder trust and corporate credibility, particularly during periods of uncertainty. Similarly, Shakil~[24] emphasizes that ESG engagement strengthens investor confidence and stakeholder loyalty, which can translate into improved financial stability and sustained profitability.
...
This methodological choice to average multiple ratings is designed to mitigate the well-documented issue of ESG rating divergence. As Berg et al.~[6] demonstrate, measurement divergence---where agencies use different indicators to measure the same attribute---is the primary driver of disagreement among ESG raters, accounting for 56\% of the total divergence. By averaging indicators from different providers, this study reduces idiosyncratic measurement noise and captures the consensus ESG performance as it is priced by financial markets. While this approach is partially limited by the rater effect---a bias where an analyst's general view of a firm influences specific category scores---creating a composite index prevents over-reliance on a single rating agency and yields a more robust, market-representative sustainability metric.
...
Third, all standard errors in the panel regression are clustered at the firm level to account for arbitrary within-firm serial correlation and heteroskedasticity~[7]. With 589 to 608 firm clusters across 21 quarterly periods, clustering at the firm level is the appropriate choice for valid panel inference.
...
These results carry important implications for the three theoretical perspectives reviewed in this study. First, the stakeholder theory perspective~[12, 20] receives strong support for the FinTech sector specifically: firms that invest in addressing stakeholder concerns---including environmental and social responsibilities---achieve measurable improvements in operational performance. Second, the shareholder value perspective~[14, 16] is partially supported by the baseline ESG coefficient for traditional firms, which is weakly negative, consistent with the view that ESG can represent a compliance cost for mature institutions. Third, signaling theory~[2, 26] provides the most compelling explanation for the differential effect: ESG functions as a credibility signal that is disproportionately valuable for firms lacking the traditional trust infrastructure of established banks.
...
% =====================================================================
%  MDPI back-matter blocks (preferred order)
% =====================================================================

\vspace{0.6em}
\noindent\textbf{Author Contributions:} Conceptualization, N.S.\ and B.D.; methodology, N.S.\ and B.D.; software, N.S.; validation, N.S.\ and B.D.; formal analysis, N.S.; investigation, N.S.; data curation, N.S.; writing---original draft preparation, N.S.; writing---review and editing, B.D.; visualization, N.S.; supervision, B.D.; project administration, B.D. All authors have read and agreed to the published version of the manuscript.

\medskip
\noindent\textbf{Funding:} This research received no external funding.

\medskip
\noindent\textbf{Institutional Review Board Statement:} Not applicable. This study relies exclusively on publicly available secondary data and does not involve human participants or animals.

\medskip
\noindent\textbf{Informed Consent Statement:} Not applicable.

\medskip
\noindent\textbf{Data Availability Statement:} The full replication package for this study---including the processed firm-level quarterly panel dataset, the Equal-Weighted and Market-Capitalization-Weighted ESG and return indices, the variable definitions and codebook, the Replication Guide, and the R and Python scripts that reproduce all reported tables---is publicly available on GitHub at \url{https://github.com/burakdogan-ds/esg-fintech-nawres-dogan} (released under the MIT License for code and CC~BY~4.0 for documentation). Raw inputs were sourced from the Bloomberg Terminal and S\&P Global under institutional license; per the data providers' terms of service, raw data cannot be redistributed and only aggregated/processed outputs are shared in the repository. To fully reproduce the analysis, users with institutional access to the Bloomberg Terminal must pull the variables specified in \texttt{docs/Variable\_Definitions\_Codebook.md} for the firms and date range listed therein, place the resulting files in the \texttt{data/raw/} directory, and execute the analysis scripts in \texttt{code/R/} or \texttt{code/Python/}.

\medskip
\noindent\textbf{Acknowledgments:} An earlier version of this work formed part of the master's thesis of the first author at the Graduate School of Bahçeşehir University. The authors gratefully thank Derese Kebede Teklie for his valuable input on the econometric specification and panel data estimation strategy. The authors also acknowledge Bahçeşehir University for providing access to the Bloomberg Terminal used in the data collection of this study.
...
% =====================================================================
%  References (MDPI numbered style, alphabetical-by-first-cite ordering
%  has been preserved from the original manuscript with numeric labels
%  used in the in-text citations above)
% =====================================================================
\begin{thebibliography}{99}\setlength{\itemsep}{2pt}

\bibitem{abbas2025}
Abbas, A.; Ali, H. Enhancing compliance and governance in FinTech-enabled public-private sustainability models. \textit{ResearchGate} \textbf{2025}. \url{https://doi.org/10.13140/RG.2.2.10078.34887}

\bibitem{ahmad2021}
Ahmad, N.; Mobarek, A.; Roni, N.N. Revisiting the impact of ESG on financial performance of FTSE350 UK firms: Static and dynamic panel data analysis. \textit{Cogent Bus.\ Manag.} \textbf{2021}, \textit{8}, 1900500. \url{https://doi.org/10.1080/23311975.2021.1900500}

\bibitem{allen2009}
Allen, F.; Carletti, E. The roles of banks in financial systems. In \textit{Oxford University Press eBooks}; Oxford University Press: Oxford, UK, 2009. \url{https://doi.org/10.1093/oxfordhb/9780199640935.013.0002}

\bibitem{alshehhi2018}
Alshehhi, A.; Nobanee, H.; Khare, N. The impact of sustainability practices on corporate financial performance: Literature trends and future research potential. \textit{Sustainability} \textbf{2018}, \textit{10}, 494. \url{https://doi.org/10.3390/su10020494}

\bibitem{bahadori2021}
Bahadori, N.; Kaymak, T.; Seraj, M. Environmental, social, and governance factors in emerging markets: The impact on firm performance. \textit{Bus.\ Strategy Dev.} \textbf{2021}, \textit{4}, 411--422. \url{https://doi.org/10.1002/bsd2.167}

\bibitem{berg2022}
Berg, F.; Kölbel, J.F.; Rigobon, R. Aggregate confusion: The divergence of ESG ratings. \textit{Rev.\ Finance} \textbf{2022}, \textit{26}, 1315--1344. \url{https://doi.org/10.1093/rof/rfac033}

\bibitem{cameron2015}
Cameron, A.C.; Miller, D.L. A practitioner's guide to cluster-robust inference. \textit{J.~Hum.\ Resour.} \textbf{2015}, \textit{50}, 317--372. \url{https://doi.org/10.3368/jhr.50.2.317}

\bibitem{chang2022}
Chang, L.; Taghizadeh-Hesary, F.; Chen, H.; Mohsin, M. Do green bonds have environmental benefits? \textit{Energy Econ.} \textbf{2022}, \textit{115}, 106356. \url{https://doi.org/10.1016/j.eneco.2022.106356}

\bibitem{chuang2025}
Chuang, M.Y.; Shrestha, S.K. FinTech converges with investment and risk: A bibliometric review. \textit{J.~Risk Financ.\ Manag.} \textbf{2025}, \textit{18}, 517. \url{https://doi.org/10.3390/jrfm18090517}

\bibitem{dye2021}
Dye, J.; McKinnon, M.; Van der Byl, C. Green gaps: Firm ESG disclosure and financial institutions' reporting requirements. \textit{J.~Sustain.\ Res.} \textbf{2021}, \textit{3}, e210006. \url{https://doi.org/10.20900/jsr20210006}

\bibitem{feyen2022}
Feyen, E.H.B.; Natarajan, H.; Saal, M. \textit{FinTech and the Future of Finance: Market and Policy Implications}; World Bank Group: Washington, DC, USA, 2022. \url{http://documents.worldbank.org/curated/en/099450005162250110}

\bibitem{freeman1984}
Freeman, R.E. \textit{Strategic Management: A Stakeholder Approach}; Pitman: Boston, MA, USA, 1984. \url{https://doi.org/10.1017/CBO9781139192675}

\bibitem{friede2015}
Friede, G.; Busch, T.; Bassen, A. ESG and financial performance: Aggregated evidence from more than 2000 empirical studies. \textit{J.~Sustain.\ Finance Invest.} \textbf{2015}, \textit{5}, 210--233. \url{https://doi.org/10.1080/20430795.2015.1118917}

\bibitem{friedman1970}
Friedman, M. The social responsibility of business is to increase its profits. \textit{The New York Times Magazine}, 13 September 1970. \url{https://doi.org/10.1007/978-3-540-70818-6_14}

\bibitem{galeone2024}
Galeone, G.; Ranaldo, S.; Fusco, A. ESG and FinTech: Are they connected? \textit{Res.~Int.\ Bus.\ Finance} \textbf{2024}, \textit{69}, 102225. \url{https://doi.org/10.1016/j.ribaf.2024.102225}

\bibitem{garciacastro2008}
Garcia-Castro, R.; Arino, M.A.; Canela, M.A. Over the long-run? Short-run impact and long-run consequences of stakeholder management. \textit{Bus.~Soc.} \textbf{2008}, \textit{50}, 428--455. \url{https://doi.org/10.1177/0007650308315493}

\bibitem{hasan2024}
Hasan, M.H.; Hossain, M.Z.; Hasan, L.; Dewan, M.A. FinTech and sustainable finance: How is FinTech shaping the future of sustainable finance? \textit{Eur.~J.~Manag.\ Econ.\ Bus.} \textbf{2024}, \textit{1}, 100--115. \url{https://doi.org/10.59324/ejmeb.2024.1(3).09}

\bibitem{kuosuwan2024}
Kuosuwan, B.; Risman, A.; Dudukalov, E.; Kozlova, E. Digital banking and environmental impact: How FinTech supports carbon footprint reduction. \textit{BIO Web Conf.} \textbf{2024}, \textit{145}, 05017. \url{https://doi.org/10.1051/bioconf/202414505017}

\bibitem{li2024}
Li, B.; Guo, F.; Xu, L.; Meng, S. FinTech business and corporate social responsibility practices. \textit{Emerg.\ Mark.\ Rev.} \textbf{2024}, \textit{59}, 101105. \url{https://doi.org/10.1016/j.ememar.2023.101105}

\bibitem{mahajan2023}
Mahajan, R.; Lim, W.M.; Sareen, M.; Kumar, S.; Panwar, R. Stakeholder theory. \textit{J.~Bus.\ Res.} \textbf{2023}, \textit{166}, 114104. \url{https://doi.org/10.1016/j.jbusres.2023.114104}

\bibitem{masila2024}
Masila, C.K.; Nyamute, W.; Okiro, K.; Irungu, M. Does corporate sustainability reporting influence financial performance? Evidence from Kenyan listed companies. \textit{Eur.~J.~Bus.\ Manag.\ Res.} \textbf{2024}, \textit{9}, 79--84. \url{https://doi.org/10.24018/ejbmr.2024.9.1.2270}

\bibitem{mertzanis2023}
Mertzanis, C. FinTech finance and social-environmental performance around the world. \textit{Finance Res.\ Lett.} \textbf{2023}, \textit{56}, 104107. \url{https://doi.org/10.1016/j.frl.2023.104107}

\bibitem{nzekwe2021}
Nzekwe, O.G.; Okoye, P.V.C.; Amahalu, N.N. Effect of sustainability reporting on financial performance of quoted industrial goods companies in Nigeria. \textit{Int.\ J.~Manag.\ Stud.\ Soc.\ Sci.\ Res.} \textbf{2021}, \textit{3}, 265--280. \url{https://www.ijmsssr.org/paper/IJMSSSR00536.pdf}

\bibitem{shakil2021}
Shakil, M.H. Environmental, social and governance performance and financial risk: Moderating role of ESG controversies and board gender diversity. \textit{Resour.\ Policy} \textbf{2021}, \textit{72}, 102144. \url{https://doi.org/10.1016/j.resourpol.2021.102144}

\bibitem{shala2024}
Shala, A.; Berisha, V. The impact of FinTech on the achievement of environmental, social, and governance (ESG) goals. In \textit{Contemporary Studies in Economic and Financial Analysis}; Emerald Publishing Limited: Bingley, UK, 2024; pp.~55--77. \url{https://doi.org/10.1108/S1569-37592024000113A004}

\bibitem{spence1973}
Spence, M. Job market signaling. \textit{Q.~J.~Econ.} \textbf{1973}, \textit{87}, 355--374. \url{https://doi.org/10.2307/1882010}

\bibitem{svoboda2023}
Svoboda, A. The role of financial services in the transition to a sustainable economy. \textit{J.~Strateg.\ Innov.\ Sustain.} \textbf{2023}, \textit{18}, 1--13. \url{https://doi.org/10.33423/jsis.v18i3.6585}

\bibitem{taera2025}
Taera, E.G.; Lakner, Z. Sustainable finance: Bridging circular economy goals and financial inclusion in developing economies. \textit{World} \textbf{2025}, \textit{6}, 44. \url{https://doi.org/10.3390/world6020044}

\bibitem{xie2019}
Xie, J.; Nozawa, W.; Yagi, M.; Fujii, H.; Managi, S. Do environmental, social, and governance activities improve corporate financial performance? \textit{Bus.~Strategy Environ.} \textbf{2019}, \textit{28}, 286--300. \url{https://doi.org/10.1002/bse.2224}

\bibitem{zhang2023}
Zhang, Q.; Anwar, M.A. Leveraging gamification technology to motivate environmentally responsible behavior: An empirical examination of Ant Forest. \textit{Decis.\ Sci.} \textbf{2023}. \url{https://doi.org/10.1111/deci.12618}
...
\newpage
\appendix
\section{Quarterly Sharpe and Treynor Ratios}\label{app:quarterly}
